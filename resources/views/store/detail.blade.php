					...
					<div clas="single-top">
						<div class="single-left">
							<div class="flexslider">
								<ul class="slides">
									<li data-thumb="{{asset('')}}/storage/{{$aaa['image'][0]->thumbnail}}">
										<div class="thumb-image"> <img src="{{asset('')}}/storage/{{$aaa['image'][0]->thumbnail}}" data-imagezoom="true" class="img-responsive"> </div>
									</li>
									<li data-thumb="{{asset('')}}/storage/{{$aaa['image'][1]->thumbnail}}">
										 <div class="thumb-image"> <img src="{{asset('')}}/storage/{{$aaa['image'][1]->thumbnail}}" data-imagezoom="true" class="img-responsive"> </div>
									</li>
									
								</ul>
							</div>
						</div>
						<div class="single-right simpleCart_shelfItem" style="padding-left: 15px;">
							<h4>{{$app['name']}}</h4>
							<div class="block">
								<div class="starbox small ghosting"> </div>
							</div>
							<p class="price item_price">{{number_format($app['price'])}}</p>
							<div class="description">
								<p><span>Quick Overview : </span>{!!$app['description']!!}</p>
							</div>
